...
{
    {
        ...
        .pin_configs = (io_t[]) {
            ...
            { .btb_pin = 17, .pin_name = "nCSA"       , .port = GPIO_PORT(A), .pin = GPIO_PIN( 4),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 23, .pin_name = "SCKA"       , .port = GPIO_PORT(B), .pin = GPIO_PIN( 3),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 25, .pin_name = "SDIA"       , .port = GPIO_PORT(B), .pin = GPIO_PIN( 5),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 27, .pin_name = "SDOA"       , .port = GPIO_PORT(B), .pin = GPIO_PIN( 4),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 19, .pin_name = "nCSB"       , .port = GPIO_PORT(A), .pin = GPIO_PIN(15),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 24, .pin_name = "SCKB"       , .port = GPIO_PORT(C), .pin = GPIO_PIN(10),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 26, .pin_name = "SDIB"       , .port = GPIO_PORT(C), .pin = GPIO_PIN(12),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 28, .pin_name = "SDOB"       , .port = GPIO_PORT(C), .pin = GPIO_PIN(11),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            ...
            { .btb_pin = 18, .pin_name = "CHSEL2"     , .port = GPIO_PORT(A), .pin = GPIO_PIN( 2),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            ...
            { .btb_pin = 51, .pin_name = "SERSEL"     , .port = GPIO_PORT(E), .pin = GPIO_PIN(14),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            ...
            { .btb_pin = 42, .pin_name = "DB4"        , .port = GPIO_PORT(D), .pin = GPIO_PIN( 4),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 44, .pin_name = "DB5"        , .port = GPIO_PORT(D), .pin = GPIO_PIN( 5),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            ...
            { .btb_pin = 37, .pin_name = "DB10"       , .port = GPIO_PORT(D), .pin = GPIO_PIN(10),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 39, .pin_name = "DB11"       , .port = GPIO_PORT(D), .pin = GPIO_PIN(11),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 41, .pin_name = "DB12"       , .port = GPIO_PORT(D), .pin = GPIO_PIN(12),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 43, .pin_name = "DB13"       , .port = GPIO_PORT(D), .pin = GPIO_PIN(13),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 45, .pin_name = "DB14"       , .port = GPIO_PORT(D), .pin = GPIO_PIN(14),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
            { .btb_pin = 47, .pin_name = "DB15"       , .port = GPIO_PORT(D), .pin = GPIO_PIN(15),  .func = BSP_IO_FUNC_INOUT, .state = IO_STATE_RESERVED },
